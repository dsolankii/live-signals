...
const RAW_INPUT_JSON = "data/real-source-mentions.json";
const PRECLEAN_INPUT_JSON = "data/real-source-mentions-preclean.json";
const OUTPUT_JSON = "data/ai-enriched-source-mentions.json";
const OUTPUT_CSV = "data/ai-enriched-source-mentions.csv";
